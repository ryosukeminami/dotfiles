...
" Required:
if dein#load_state('/Users/ryosuke/.vim/bundles')
  call dein#begin('/Users/ryosuke/.vim/bundles')

  " Let dein manage dein
  " Required:
  call dein#add('/Users/ryosuke/.vim/bundles/repos/github.com/Shougo/dein.vim')
